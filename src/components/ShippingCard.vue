<template>
    <div class="content" v-if="line_order" style="margin: 10px;">
        ...
        <div v-if="requestFrom=='my-store'">
            <a v-if="line_order.pre_order_user" style="text-align: left;width: 50%;display: inline-block;color: #000;">
                <label class="break-word-customer font-12">
            ...
            <a style="text-align: right;width: 50%;display: inline-block;color: #000;">
                <label class="break-word-customer font-11">
                    <em>{{$filters.formatDate(line_order.created_at, $i18n.locale)}}</em></label>
            </a>
        </div>
        ...
        <strong v-if="requestFrom=='shippings'" class="no-effect color-theme" :class="!in_apply_form?'break-word':''" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" style="display: block;">
            <img class="tw:inline tw:w-[20px]" src="/site_images/svg/marker-blue.svg">
        ...
        <strong v-if="line_order.is_pre_order" class="no-effect color-theme" :class="!in_apply_form?'break-word':''" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false">
            <img class="tw:inline tw:w-[20px]" src="/site_images/svg/marker-red.svg">
