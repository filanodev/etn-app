<template>
    <div class="header header-fixed header-logo-center" style="background-color: rgba(255, 255, 255, 0.9);overflow: hidden;">
        ...
        text-overflow: ellipsis;">
            ...
            <!-- <img class="inline me-1" v-show="show_profile_image" :src="profile_img" alt="avatar" style="width: 30px;height: 30px;border-radius: 50%;object-fit: cover;"> -->
            <div v-if="show_page_title && user" class="tw:inline-block tw:align-middle">
            ...
            <div class="tw:inline-flex" style="">
                ...
                <div v-show="!show_page_title" class="tw:inline" style="margin-right: 10px;margin-left: 0px;margin-top: 0;margin-bottom: 10px;">
                    ...
                    <div class="btn btn-dark-piketplace tw:inline-block" style="margin-left: -20px;margin-left: -41px;padding: 2px 8px;text-align: center;margin-bottom: 3px;border-radius: 15px!important;background-color: #000!important;">
                        <i class="fas fa-search tw:align-text-bottom color-white" style="font-size: 20px;" @click="call_search"></i>
                    </div>
                    <div @click="$show_modal.show_modal({id:'filter'});" class="tw:inline" style="width: 20%;padding: 5px 5px 5px 11px;cursor: pointer;margin-left: 0px;text-align: right;">
                        <span class="tw:align-middle" v-if="selected_country_search && selected_country_search.iso2!='all'" v-html="$functions.isoToEmoji(selected_country_search.iso2)"></span>
                        <img v-else class="tw:inline tw:align-middle" src="/site_images/svg/globe.svg" style="width: 15px;vertical-align: middle;">
                        ...
                        <i class="fas fa-angle-down tw:align-middle"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <span v-show="isLoggedIn" class="header-icon" :class="'header-icon-4'" style="height: 100%;">
            <span @click="$router.push({ name: 'notifications'})" style="height: 80%;margin-right: 10px;display: inline-block;vertical-align: middle;">
                <a style="display: block;">
                    ...
                    <svg class="tw:inline tw:align-[sub!important]" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8.35179 20.2418C9.19288 21.311 10.5142 22 12 22C13.4858 22 14.8071 21.311 15.6482 20.2418C13.2264 20.57 10.7736 20.57 8.35179 20.2418Z" fill="#a63289"></path> <path d="M18.7491 9V9.7041C18.7491 10.5491 18.9903 11.3752 19.4422 12.0782L20.5496 13.8012C21.5612 15.3749 20.789 17.5139 19.0296 18.0116C14.4273 19.3134 9.57274 19.3134 4.97036 18.0116C3.21105 17.5139 2.43882 15.3749 3.45036 13.8012L4.5578 12.0782C5.00972 11.3752 5.25087 10.5491 5.25087 9.7041V9C5.25087 5.13401 8.27256 2 12 2C15.7274 2 18.7491 5.13401 18.7491 9Z" fill="#a63289"></path> </g></svg>
                </a>
